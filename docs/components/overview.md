...
| `PdfImportWizard` | Wizard overlay de 4 pasos para “Importar desde PDF” (análisis IA + revisión + aplicación); persiste el job en `localStorage` por tipo de proyecto para retomar sin re-analizar |
